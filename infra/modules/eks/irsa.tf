...
# Role that only the cluster-autoscaler service account can assume
resource "aws_iam_role" "cluster_autoscaler" {
  name = "surveillance-cluster-autoscaler"
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Condition = {
          StringEquals = {
            "aws:ResourceTag/k8s.io/cluster-autoscaler/surveillance-prod" = "owned"
          }
        }
      }
    ]
